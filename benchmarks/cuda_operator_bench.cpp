...
int main(int argc, char** argv) {
    try {
        ...
        const auto split = gfss::apply_node_stencil_cuda_interior_split(mesh, material, xf, repeats);
        ...
        const double split_mdof_s = gpu_mdof_s(split, mesh.dof_count());
        ...
        const double split_rel = relative_max_difference(oracle, split.y);
        ...
        print_gpu("gpu_interior_split_32x16", split, mesh.dof_count());
        ...
        std::cout << "best_node_speedup_vs_atomic=" << (best_node_mdof_s / atomic_mdof_s) << "x\n"
                  ...
                  << "interior_split_speedup_vs_gold3d=" << (split_mdof_s / best_gold3d_mdof_s) << "x\n"
                  << "interior_split_speedup_vs_cpu_gold_in_run=" << (split_mdof_s / cpu_mdof_s) << "x\n"
                  ...
                  << "interior_split_device_vectors="
                  << (static_cast<double>(split.device_bytes) / (1024.0 * 1024.0)) << " MiB\n"
                  << std::scientific
                  ...
                  << "interior_split_vs_oracle_rel_max=" << split_rel << '\n';
